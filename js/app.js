...
function initMap() {
    ...
    map = new google.maps.Map(document.getElementById('map'), {
        center: {lat: 26.218287, lng: 78.182831},
        zoom: 13,
        styles: styles,
...
var AppViewModel = function () {
    ...
    function fetchCafes() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: 'client_id=ZY4CDJNSF1SWOWSP1AYCW3WKA5CEAUR1YBRCRE4LTGNQN5ZG&client_secret=OBRHMM00CX5DGDRTKTMMEDST1U00PA33UCQXMD0HBMCQQCAC&v=20130815%20&ll=26.218287,78.182831%20&query=cafe',
            async: true,
